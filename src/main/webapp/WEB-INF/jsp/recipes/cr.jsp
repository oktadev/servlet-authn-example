...
<p class="xs-text-2 xs-mb2">for 12 servings</p>
        ...
        <li class="xs-mb1 xs-mt0">
          ...
          <div id="nutrition-details" class="nutrition-details xs-hide xs-mt1 xs-text-3 xs-col-12">
              ...
              <ul class="list-unstyled xs-mb1">
                  Calories
              <span class="bold"> 584</span>
              </ul>
              
              <ul class="list-unstyled xs-mb1">
                  Fat
              <span class="bold"> 28g</span>
              </ul>
              
              <ul class="list-unstyled xs-mb1">
                  Carbs
              <span class="bold"> 74g</span>
              </ul>
              
              <ul class="list-unstyled xs-mb1">
                  Fiber
              <span class="bold"> 2g</span>
              </ul>
...
<div class="prep col md-col-8 xs-mx2 xs-mb4 xs-mt2 md-mt0 xs-flex-order-3 md-flex-order-2">
  ...
  <div>
    <ol class="prep-steps list-unstyled xs-text-3">
            ...
            <li class="xs-mb2">Generously butter a 1-inch cast-iron skillet or cake pan.</li>
      
      
      
      
            <li class="xs-mb2">In a large bowl, whisk together the warm milk, melted butter, and granulated sugar. The mixture should be just warm, registering between 100-110˚F (40˚C). If hotter, allow to cool slightly before proceeding. </li>
      
      
      
      
            <li class="xs-mb2">Sprinkle the yeast evenly over the warm mixture and let sit for 1 minute. Add 4 cups of the flour to the milk mixture and mix with a wooden spoon until just combined. Cover the bowl with a towel or plastic wrap and set in a warm place to rise for 1 hour.</li>
            ...
            <li class="xs-mb2">Make the filling: In a small bowl, combine the softened butter, light brown sugar, and cinnamon. </li>
      
      
      
      
            <li class="xs-mb2">Spread the filling mixture evenly over the rolled-out dough, spreading right to the edges. </li>
      
      
      
      
            <li class="xs-mb2">Using a pizza cutter, make 3 horizontal cuts to divide the dough into 4 long, evenly-sized strips. Starting from the top, roll the first strip up from right to left. Take the first roll and place it on top of the next strip, starting again on the right side and rolling up right to left, building on the first. Continue with the remaining strips until you have a giant cinnamon roll.</li>
      
      
      
      
            <li class="xs-mb2">Place the giant cinnamon roll in the prepared skillet or cake pan and cover with plastic wrap. Place in a warm spot and leave to rise for 30 minutes. The cinnamon roll should expand to the edges of the pan during this time.</li>
      
      
      
      
            <li class="xs-mb2">Preheat the oven to 325˚F (160˚C).</li>
      
      
      
      
            <li class="xs-mb2">Uncover the cinnamon roll and bake for 45 minutes. Cover the roll with foil to prevent the outside from burning, and bake for an additional 35 minutes.</li>
      
      
      
      
            <li class="xs-mb2">While the cinnamon roll is baking, prepare the frosting: In a medium bowl, whisk together the cream cheese, butter, milk, vanilla, and powdered sugar until smooth.</li>
      
      
      
      
            <li class="xs-mb2">Remove the cinnamon roll from the oven and let cool in the pan for at least 20 minutes. Once cool, remove from the pan and drizzle the frosting over the roll before serving.</li>
