  ...
  <div class="ingredients__section xs-mt1 xs-mb3">
    ...
    <ul class="list-unstyled xs-text-3">
        ...
        <li class="xs-mb1 xs-mt0">
          ...
          fresh basil, minced, plus more for garnish
...
<div class="prep col md-col-8 xs-mx2 xs-mb4 xs-mt2 md-mt0 xs-flex-order-3 md-flex-order-2">
  ...
  <div>
    <ol class="prep-steps list-unstyled xs-text-3">
            ...
            <li class="xs-mb2">Arrange the slices in a single layer on a baking sheet lined with paper towels.</li>
      
      
      
      
            <li class="xs-mb2">Sprinkle the eggplant with half of the coarse salt. Flip the slices over and sprinkle with the rest of the salt.</li>
      
      
      
      
            <li class="xs-mb2">Put another baking sheet on top of the eggplant and place something heavy, like a cast-iron skillet, on the top baking sheet to help release moisture from the eggplant. Let sit for 30 minutes.</li>
      
      
      
      
            <li class="xs-mb2">Uncover the eggplant slices and pat dry with paper towels. Brush most of the salt from the eggplant with a paper towel, then transfer to a medium bowl. Set aside.</li>
      
      
      
      
            <li class="xs-mb2">In a separate medium bowl, combine the flour, oregano, basil, garlic powder, and pepper. Mix well.</li>
            ...
            <li class="xs-mb2">Coat each eggplant slice in the flour mixture, shaking off any excess flour.</li>
            ...
            <li class="xs-mb2">Fry the eggplant in batches until golden brown on both sides, 2-3 minutes per side. Drain on a paper towel-lined baking sheet and pat dry using more paper towels to absorb excess oil.</li>
            ...
            <li class="xs-mb2">Bake for 30 minutes, until the mozzarella is bubbling and golden brown.</li>
      
      
      
      
            <li class="xs-mb2">Let cool for 10 minutes, then serve garnished with fresh basil.</li>
